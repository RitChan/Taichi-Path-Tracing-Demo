...
if __name__ == '__main__':
    ...
    triangles = Triangles([
        Triangles.create([-0.5, 0, -1], [0.5, 0, -1], [-0.5, 0.5, -2], color=(1.0, 0.7, 0.2)),
        Triangles.create([-0.5, 0.5, -2], [0.5, 0, -1], [0.5, 0.5, -2], color=(1.0, 0.7, 0.2))
    ])
    lights = Lights([
        Lights.create(origin=[-0.5, 0.5, -2], dir_x=[1, 0, 0], dir_y=[0, 0, 1], power=5, color=(1, 1, 1))
    ])
